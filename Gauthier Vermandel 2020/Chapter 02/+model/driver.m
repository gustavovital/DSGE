...
M_.param_names_long(7) = {'Trend Factor'};
...
M_.params(7) = 1.0078;
gamma = M_.params(7);
M_.params(6) = (M_.params(7)/M_.params(2)-1+M_.params(3))*(1/M_.params(1))^(1/(M_.params(1)-1));
Kss = M_.params(6);
M_.params(5) = M_.params(6)^M_.params(1)-M_.params(6)*(1-M_.params(3)-M_.params(7));
Css = M_.params(5);
...
estim_params_.var_exo = [estim_params_.var_exo; 1, 0.007, 0, Inf, 0, NaN, NaN, NaN, NaN, NaN ];
options_.datafile = 'mydata.mat';
options_.order = 1;
var_list_ = {'y'};
