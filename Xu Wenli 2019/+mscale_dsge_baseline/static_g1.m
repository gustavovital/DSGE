...
if T_flag
    T = mscale_dsge_baseline.static_g1_tt(T, y, x, params);
end
g1 = zeros(30, 30);
g1(1,1)=1+y(27);
...
g1(30,3)=(-(y(10)*(1-params(2))/(y(3)-y(3)*params(2))));
g1(30,10)=(-(log(y(3)-y(3)*params(2))-y(11)*T(5)/(1+params(11))));
g1(30,11)=(-(y(10)*(-(T(5)/(1+params(11))))));
g1(30,16)=(-(y(10)*(-(y(11)*T(30)/(1+params(11))))));
g1(30,30)=1-params(1);
if ~isreal(g1)
