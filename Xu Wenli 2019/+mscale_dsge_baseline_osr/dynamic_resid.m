...
if T_flag
    T = mscale_dsge_baseline_osr.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(29, 1);
lhs = (1+y(44))*y(18);
rhs = y(27)/(y(20)-params(2)*y(1))-params(2)*params(1)*y(55)/(y(49)-y(20)*params(2));
residual(1) = lhs - rhs;
lhs = y(18)*(1-y(46))*y(23);
rhs = y(19)*(params(5)+params(6)*(y(24)-1));
residual(2) = lhs - rhs;
lhs = y(18);
rhs = params(1)*y(47)*(1+y(21))*T(1);
residual(3) = lhs - rhs;
lhs = (1+y(44))*y(18);
rhs = y(19)*y(25)*T(4)+T(6)*T(7);
residual(4) = lhs - rhs;
lhs = y(19);
rhs = params(1)*(y(47)*(1-y(61))*y(51)*y(52)+y(48)*T(9));
residual(5) = lhs - rhs;
lhs = y(31);
rhs = y(27)*y(28)*T(11)*T(12)+T(13)*T(14)*T(16)*y(57);
residual(6) = lhs - rhs;
lhs = y(32);
rhs = y(33)*y(18)*(1-y(45))*T(17)+T(18)*T(19)*T(20)*y(58);
residual(7) = lhs - rhs;
lhs = y(30);
...
residual(10) = lhs - rhs;
lhs = y(38);
rhs = y(18)*y(36)*y(40)+T(25)*T(26)*y(59);
residual(11) = lhs - rhs;
lhs = y(39);
rhs = y(18)*y(40)+T(27)*T(28)*y(60);
residual(12) = lhs - rhs;
lhs = 1+y(37);
rhs = y(38)*T(29)/y(39);
residual(13) = lhs - rhs;
