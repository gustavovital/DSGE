...
residual = zeros(36, 1);
lhs = (1+y(44))*y(18);
rhs = y(27)/(y(20)-params(2)*y(1))-params(2)*params(1)*y(62)/(y(56)-y(20)*params(2));
residual(1) = lhs - rhs;
lhs = y(18)*(1-y(46))*y(23);
rhs = y(19)*(params(5)+params(6)*(y(24)-1));
residual(2) = lhs - rhs;
lhs = y(18);
rhs = params(1)*y(54)*(1+y(21))*T(1);
residual(3) = lhs - rhs;
lhs = (1+y(44))*y(18);
rhs = y(19)*y(25)*T(4)+T(6)*T(7);
residual(4) = lhs - rhs;
lhs = y(19);
rhs = params(1)*(y(54)*(1-y(68))*y(58)*y(59)+y(55)*T(9));
residual(5) = lhs - rhs;
lhs = y(31);
rhs = y(27)*y(28)*T(11)*T(12)+T(13)*T(14)*T(16)*y(64);
residual(6) = lhs - rhs;
lhs = y(32);
rhs = y(33)*y(18)*(1-y(45))*T(17)+T(18)*T(19)*T(20)*y(65);
residual(7) = lhs - rhs;
lhs = y(30);
...
residual(10) = lhs - rhs;
lhs = y(38);
rhs = y(18)*y(36)*y(40)+T(25)*T(26)*y(66);
residual(11) = lhs - rhs;
lhs = y(39);
rhs = y(18)*y(40)+T(27)*T(28)*y(67);
residual(12) = lhs - rhs;
lhs = 1+y(37);
rhs = y(38)*T(29)/y(39);
residual(13) = lhs - rhs;
...
residual(35) = lhs - rhs;
lhs = y(47);
rhs = y(27)*(log(y(20)-params(2)*y(1))-y(28)*T(12)/(1+params(11)))+params(1)*y(69);
residual(36) = lhs - rhs;
