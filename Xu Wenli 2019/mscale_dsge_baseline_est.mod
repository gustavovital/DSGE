...
% @Wenli Xu, Anhui University/CIMERS
% xuweny87@hotmail.com
% 2019-2-24
%
% extend CEE（2005，JPE)，SW(2007,AER) and Sims（2017），
...
/*
    \item[a] Productive
    \item[b] Marginal efficiency of investment
    \item[c] Governmental expenditure
    \item[d] Added value tax
    \item[e] labor income tax
    \item[f] capital rent tax
    \item[g] Monetary policy
    \item[h] Intertemporal preferences
    \item[i] Intratemporal preferences(labor supply)
*/
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
estimation(datafile=msnk_baseline,mode_compute=6,mh_replic=2000,mh_jscale=0.8,mode_check,bayesian_irf,forecast=20)Y;
