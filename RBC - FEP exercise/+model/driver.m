...
M_.param_names(5) = {'sigb'};
M_.param_names_tex(5) = {'sigb'};
M_.param_names_long(5) = {'sigb'};
...
iss  = dlt*kss;
css  = yss-iss;
M_.params(6) = (kss/nss)^M_.params(1)*1/(css*(-((1-nss)^(-M_.params(7)))));
psi = M_.params(6);
%
